...
conversation_id = "ecf82eb1-646f-49f0-874d-a5391c7f97f8"
...
if os.path.exists(log_path):
    with open(log_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            # Check for content containing search results in MODEL response or tool outputs
            ...
            # Also check tool_calls and tool outputs in the same line or adjacent lines
            # If it's a SEARCH_WEB type step, it will have content representing the search results
