...
conversation_id = "cb8fc0fe-7158-4881-949e-3c848400b300"
...
# 1. Read queries from lines 1 to 50 of batch_queries.txt
raw_lines = []
with open(batch_queries_path, 'r', encoding='utf-8') as f:
    for idx, line in enumerate(f, 1):
        raw_lines.append((idx, line.strip()))

target_queries = [q for idx, q in raw_lines if 1 <= idx <= 50]

print(f"Loaded {len(target_queries)} target queries from lines 1 to 50 of batch_queries.txt.")
