...
def clean_name(name):
    # Remove titles like Mr., Dr., Mrs., Ms.
        ...
        with urllib.request.urlopen(req, timeout=15) as response:
            ...
            for result in soup.find_all('div', class_='result'):
                ...
                if title_a:
                    ...
                    href = title_a['href']
                    # DuckDuckGo redirect url parsing
...
def main():
    ...
    for author in AUTHORS:
        ...
        # Query 1: "[Author Name]" site:linkedin.com/in
        ...
        # Query 2: "[Author Name]" site:github.com OR site:udemy.com/user OR site:medium.com
